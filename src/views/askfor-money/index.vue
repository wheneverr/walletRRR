...
<div>
    <el-card>
      ...
      <el-form :model="requestForm" label-width="120px" style="padding-left: 10%;padding-right: 10%;">
        <el-form-item label="账号类型">
              <el-select v-model="requestForm.accountType" placeholder="请选择账号类型">
                  <el-option label="电话" value=0></el-option>
                  <el-option label="电子邮件" value=1></el-option>
              </el-select>
          </el-form-item>
          <el-form-item label="对方账号">
            <el-input v-model="requestForm.account"></el-input>
          </el-form-item>
          <el-form-item label="金额">
            <el-input v-model="requestForm.amount"></el-input>
          </el-form-item>
          <el-form-item label="支付密码">
            <el-input v-model="requestForm.payPwd" type="password"></el-input>
          </el-form-item>
...
export default{
    ...
    methods: {
      ...
      validateRequestForm(){
        if(this.requestForm.account === ''){
          return false
        }
        if(this.requestForm.amount <= 0){
          return false
        }
        if(this.requestForm.accountType === ''){
          return false
        }
        return true
      },
